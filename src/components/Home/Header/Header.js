    ...
    return (
        <>
            <div className='h-full relative bgImg text-[#fff] flex flex-col mx-auto'>
                <div className='flex justify-center gap-[300px] max-xl:gap-[150px] max-lg:gap-[150px] max-[850px]:gap-[80px] max-sm:gap-y-5 max-sm:flex-col max-sm:items-center pt-[120px] max-sm:pt-[50px] pb-[70px] max-md:pb-[50px]'>
                    <div className='flex flex-col justify-start max-w-lg max-lg:max-w-sm max-md:w-[300px]  max-sm:items-center'>
                        ...
                        <Link href="/"><button className='bg-[#5B422E] rounded-lg mt-[0px] w-[155px] max-sm:w-[100px] max-sm:h-[40px] max-md:w-[120px] max-md:h-[50px] h-[70px] text-[#fff] text-[16px] max-sm:text-[11px] max-sm:text-[14px]'>
                            Explore More
                        </button></Link>
                    </div>
