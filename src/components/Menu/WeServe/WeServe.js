    ...
    <>
      <div className='bg-[#F5F9D6] w-full h-full'>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-[20px] max-xl:text-[17px] max-lg:text-[16px] max-md:text-[14px] max-sm:text-[12px] text-center text-[#1E1E1E] w-[800px] max-lg:w-[600px] max-md:w-[500px] max-md:w-[300px]'> We serve a variety of refreshments, snacks and delicacies to satisfy your taste buds and make sure you get the best experience with us</p>
