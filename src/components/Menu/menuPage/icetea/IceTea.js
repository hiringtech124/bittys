...
function IceTea() {
  const items = [
    ...
    {
      img: img2,
      itemName: "Litchi Iced Tea",
      price: "60/-"
    },
    {
      img: img3,
      itemName: "Blueberry Iced Tea",
      price: "60/-"
    },
    {
      img: img4,
      itemName: "Orange Iced Tea",
      price: "60/-"
    },
    {
      img: img5,
      itemName: "Watermelon Iced Tea",
      price: "60/-"
    },
  ...
  return (
    <>
      <div className='h-full w-full bg-[#F5F9D6] flex flex-col items-center px-[20px] max-[450px]:px-[0px]'>
        <h1 className='flex justify-start w-[100%] font-serif font-bold text-[#4D3029] text-[64px] max-xl:text-[54px] max-lg:text-[44px] max-md:text-[34px] max-[450px]:text-[28px]'>Iced Tea</h1>
        <p className='font-serif text-[32px] max-xl:text-[26px] max-lg:text-[22px] max-md:text-[14px] max-[450px]:w-[200px] py-[10px]'>Cool off with our refreshing iced tea, available in a variety of flavors.</p>
