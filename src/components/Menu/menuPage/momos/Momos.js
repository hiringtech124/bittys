...
function Momos() {
  const items = [
    ...
    {
      img: img3,
      itemName: "Paneer Steam",
      price: "70/-"
    },
    {
      img: img4,
      itemName: "Paneer Fried",
      price: "80/-"
    },
    {
      img: img5,
      itemName: "Cheese Fried",
      price: "80/-"
    },
    {
        img: img6,
        itemName: "Cheese Corn Steam",
        price: "70/-"
      },
      {
        img: img7,
        itemName: "Cheese Corn Fried",
        price: "80/-"
      },
  ...
  return (
    <>
      <div className='h-full w-full bg-[#F5F9D6] flex flex-col items-center px-[20px] max-[450px]:px-[0px]'>
        <h1 className='flex justify-start w-[100%] font-serif font-bold text-[#4D3029] text-[64px] max-xl:text-[54px] max-lg:text-[44px] max-md:text-[34px] max-[450px]:text-[28px]'>Momos</h1>
        <p className='font-serif text-[32px] max-xl:text-[26px] max-lg:text-[22px] max-md:text-[14px] max-[450px]:w-[200px] py-[10px]'>Delight in the savory goodness of our steamed or fried momos.</p>
