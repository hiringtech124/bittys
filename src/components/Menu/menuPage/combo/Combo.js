...
function Combo() {
  const beveragesCategory = data.categories.find(category => category.name === "Combo's"); 
  ...
  return (
    <>
      <div className='h-full w-full bg-[#F5F9D6] flex flex-col items-center px-[20px] max-[450px]:px-[0px]'>
        ...
        <p className='font-serif text-[32px] max-xl:text-[26px] max-lg:text-[22px] max-md:text-[14px] max-[450px]:w-[200px] py-[10px]'>Get the best of both worlds with our perfectly paired combos.</p>
