  ...
  return (
    <>
      <div className='h-full w-full bg-[#F5F9D6] pt-[50px] flex flex-col items-center'>
        <h1 className='flex justify-start w-[90%] font-serif font-bold text-[#4D3029] text-[64px] '>Main Course</h1>
        <div className='grid grid-cols-3 gap-x-[100px] gap-y-[200px] pt-[200px]'>
          ...
          <div className='flex flex-col items-center justify-center border border-[#8D4242] w-[320px] h-[360px] pb-[10px] relative  '>
            <Image className="w-[250px] h-[250px] absolute top-[-35%]" src={img7} alt="Baverage" />
          ...
          <div className='flex flex-col items-center justify-center border border-[#8D4242] w-[320px] h-[360px] pb-[10px] relative  '>
            <Image className="w-[250px] h-[250px] absolute top-[-35%]" src={img8} alt="Baverage" />
          ...
          <div className='flex flex-col items-center justify-center border border-[#8D4242] w-[320px] h-[360px] pb-[10px] relative  '>
            <Image className="w-[250px] h-[250px] absolute top-[-35%]" src={img9} alt="Baverage" />
