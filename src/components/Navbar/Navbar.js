    ...
    return (
        <>
            ...
            <div className='h-full w-full text-[#fff] w-full flex justify-between max-sm:justify-center max-sm:items-center'>
                ...
                <ul className={`w-[850px] gap-10 max-xl:gap-8 max-lg:gap-5 justify-end flex max-sm:flex-col max-sm:justify-center max-sm:gap-10 max-xl:w-[700px]  max-lg:w-[600px] max-md:w-[450px] pt-[30px] pb-[30px] pr-[100px] max-lg:pr-[30px] max-sm:absolute max-sm:bg-black max-sm:bg-opacity-95 z-[5] max-sm:w-[100%] max-sm:h-screen ${open ? 'top-[0%]' : 'top-[-490px]'}`}>
