...
function Products() {
  return (
    <>
      <div className='backImg h-screen w-full flex flex-col items-center max-md:h-full'>
        ...
        <div className='flex mt-[30px] max-md:flex-col h-full '>
          <div className='flex flex-col mr-[150px] max-xl:mr-[80px] max-lg:mr-[30px] max-sm:mr-[0] max-sm:ml-[10px] '>
            <div className='mb-[15px] max-sm:mb-[5px] '>
              <h1 className='font-serif text-[35px] font-bold max-xl:text-[30px] max-lg:text-[25px] max-sm:text-[21px]'>Product 1-----------------------₹100</h1>
              <p className='font-serif text-[20px] w-[500px] max-xl:w-[400px] max-xl:text-[17px] max-lg:w-[350px] max-lg:text-[15px] max-sm:text-[12px] max-sm:w-[300px]'>Lorem ipsum Lorem ipsum dolor sit Lorem ipsum Lorem ipsum dolor sit Lorem ipsum Lorem ipsum dolor sit Lore</p>
            </div>
